...
SELECT
  ...
  COALESCE(round((sum(st_length(s.geom)) FILTER (WHERE s.downstream_barrier_id_15_sar IS NULL) / 1000)::numeric, 1), 0) AS length_km_accessible15,
  COALESCE(round((sum(st_length(s.geom)) FILTER (WHERE s.downstream_barrier_id_15_sar IS NULL AND s.downstream_barrier_id_structure IS NULL) / 1000)::numeric, 1), 0) AS length_km_accessible15_structureless,
  COALESCE(round((sum(st_length(s.geom)) FILTER (WHERE s.downstream_barrier_id_20_sar IS NULL) / 1000)::numeric, 1), 0) AS length_km_accessible20,
  COALESCE(round((sum(st_length(s.geom)) FILTER (WHERE s.downstream_barrier_id_20_sar IS NULL AND s.downstream_barrier_id_structure IS NULL) / 1000)::numeric, 1), 0) AS length_km_accessible20_structureless,
  COALESCE(round((sum(st_length(s.geom)) FILTER (WHERE s.downstream_barrier_id_30_sar IS NULL) / 1000)::numeric, 1), 0) AS length_km_accessible30,
  COALESCE(round((sum(st_length(s.geom)) FILTER (WHERE s.downstream_barrier_id_30_sar IS NULL AND s.downstream_barrier_id_structure IS NULL) / 1000)::numeric, 1), 0) AS length_km_accessible30_structureless,
  COALESCE(round((SUM(ST_Length(s.geom)) FILTER (WHERE s.downstream_barrier_id_15_sar IS NULL AND (wb.waterbody_type IS NULL AND s.edge_type IN (1000,1100,2000,2300)) OR wb.waterbody_type = 'R') / 1000)::numeric, 1), 0) AS stream_km_accessible15,
  COALESCE(round((SUM(ST_Length(s.geom)) FILTER (WHERE s.downstream_barrier_id_15_sar IS NULL AND s.downstream_barrier_id_structure IS NULL AND (wb.waterbody_type IS NULL AND s.edge_type IN (1000,1100,2000,2300)) OR wb.waterbody_type = 'R') / 1000)::numeric, 1), 0) AS stream_km_accessible15_structureless,
  COALESCE(round((SUM(ST_Length(s.geom)) FILTER (WHERE s.downstream_barrier_id_20_sar IS NULL AND (wb.waterbody_type IS NULL AND s.edge_type IN (1000,1100,2000,2300)) OR wb.waterbody_type = 'R') / 1000)::numeric, 1), 0) AS stream_km_accessible20,
  COALESCE(round((SUM(ST_Length(s.geom)) FILTER (WHERE s.downstream_barrier_id_20_sar IS NULL AND s.downstream_barrier_id_structure IS NULL AND (wb.waterbody_type IS NULL AND s.edge_type IN (1000,1100,2000,2300)) OR wb.waterbody_type = 'R') / 1000)::numeric, 1), 0) AS stream_km_accessible20_structureless,
  COALESCE(round((SUM(ST_Length(s.geom)) FILTER (WHERE s.downstream_barrier_id_30_sar IS NULL AND (wb.waterbody_type IS NULL AND s.edge_type IN (1000,1100,2000,2300)) OR wb.waterbody_type = 'R') / 1000)::numeric, 1), 0) AS stream_km_accessible30,
  COALESCE(round((SUM(ST_Length(s.geom)) FILTER (WHERE s.downstream_barrier_id_30_sar IS NULL AND s.downstream_barrier_id_structure IS NULL AND (wb.waterbody_type IS NULL AND s.edge_type IN (1000,1100,2000,2300)) OR wb.waterbody_type = 'R') / 1000)::numeric, 1), 0) AS stream_km_accessible30_structureless
